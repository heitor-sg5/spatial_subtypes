"""
Spatial subtyping of macrophages in the full tissue, using the 
default parameters (delaunay graph, lam=0.3, resolution=1.0). 
Produces a figure with three panels: raw Leiden labels, validated 
labels, and Oliveira et al. ground truth
"""
...
def _scatter_by_label(ax, coords, labels, title, unresolved_values=("unresolved", "NA")):
    """
    Scatter-plots the given coordinates, coloring by the given labels.
    """
